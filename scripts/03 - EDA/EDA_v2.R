...
library(forcats)
library(patchwork)
library(here)        ## NUEVO: Paquete clave para manejar rutas de archivos de forma portátil.

# --- NOTA IMPORTANTE ---
# Asegúrate de tener el paquete 'here' instalado. Si no, ejecuta la siguiente línea:
